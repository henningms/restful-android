...
{
	public static RestHttpRequestDetail buildRequestFromProxyMethod(
			Method method, Object[] arguments)
	{
		...
		String path = ProxyHelper.getAbsolutePathFromProxyMethod(method,
				arguments);
	...
	public static String getServicePathFromModel(Class<? extends Model> model)
	{
		...
		Class<? extends RestService> restService = GenericHelper
				.getRestServiceFromModel(model);
	...
	public static String getServicePathFromRestService(
	...
	public static String getServiceSuffixFromRestService(
			Class<? extends RestService> service)
	{
		if (service == null) return null;
		...
		if (urlAnnotation == null) return null;

		return urlAnnotation.suffix();
	}

	public static HttpUriRequest buildHttpUriRequestFromUrlAndMethod(
			String url, String verb)
	{
	...
	public static String getBasicAuthenticationFromModel(
	...
	public static boolean modelHasBasicAuthentication(
			Class<? extends Model> model)
	{
