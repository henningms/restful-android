...
public class RestHttpRequestDetail
{
	...
	public RestHttpRequestDetail(Class<? extends Model> modelClass, String url,
	...
	public RestHttpRequestDetail(Model model)
	{
		...
		this.requestUrl = HttpHelper.getAbsolutePathFromModel(modelClass)
				+ ".json";
	...
	{
		HttpUriRequest request = HttpHelper
				.buildHttpUriRequestFromUrlAndMethod(requestUrl, requestMethod);
	...
	private void addBasicAuthentication(HttpUriRequest request)
	{
		...
		String authString = HttpHelper
				.getBasicAuthenticationFromModel(modelClass);

		if (authString == null) return;

		Log.d("restful",
				"addBasicAuthentication: This request has been set to include authentication..");
